...
const Placeholder = ({ title }: { title: string }) => (
  <div className="min-h-screen pt-32 pb-20 flex items-center justify-center bg-accent">
    <div className="text-center">
      <h1 className="text-4xl md:text-6xl font-bold text-primary-950 mb-4">{title}</h1>
      <p className="text-primary-700">This page is under construction.</p>
    </div>
  </div>
);
